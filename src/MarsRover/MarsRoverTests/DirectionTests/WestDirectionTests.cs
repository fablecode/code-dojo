...
public class WestDirectionTests
{
    ...
    public void SetUp()
    {
        ...
        _sut = new West(_landscape);
    }

    [Test]
    public void Given_A_Turn_Left_Command_Direction_Should_Be_South()
    {
        // Arrange
        // Act
    ...
    [Test]
    public void Given_A_Turn_Right_Command_Direction_Should_Be_North()
    {
        // Arrange
        // Act
