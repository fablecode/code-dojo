...
public class NorthDirectionTests
{
    ...
    public void SetUp()
    {
        ...
        _sut = new North(_landscape);
    }

    [Test]
    public void Given_A_Turn_Left_Command_Direction_Should_Be_West()
    {
        // Arrange
        // Act
    ...
    [Test]
    public void Given_A_Turn_Right_Command_Direction_Should_Be_East()
    {
        // Arrange
        // Act
    ...
    public void Given_A_Move_Command_Should_Not_Pass_Boundary()
    {
        ...
        using (new AssertionScope())
        {
            ...
            _landscape.CoordinateY.Should().Be(5);
        }
    }
